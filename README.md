🎯 Jadah AI | جادة AI
 🇸🇦 جادة AI - مساعد سطح المكتب للإرشاد البصري التفاعلي
...
Python 3.9 أو أحدث: تأكد من تفعيل خيار إضافة بايثون إلى مسار النظام (Add Python to PATH) أثناء التثبيت.

Ollama: يجب أن يكون مثبتاً ومستضافاً محلياً على جهازك لتشغيل النماذج الذكية.

Tesseract OCR (لنظام ويندوز):

قم بتحميل نسخة التثبيت الخاصة بويندوز من الرابط التالي: UB-Mannheim Tesseract Installers.
...
└── README.md               # ملف دليل المشروع
 🇬🇧 Jadah AI - Desktop Assistant for Interactive Visual Guidance
...
Python 3.9 or higher: Ensure the "Add Python to PATH" option is checked during installation.

Ollama: Must be installed and hosted locally on your machine to drive the intelligent model orchestration.

Tesseract OCR (for Windows):

Download the Windows binaries from: UB-Mannheim Tesseract Installers.
